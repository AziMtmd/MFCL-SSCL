...
class Decoder_1(tf.keras.layers.Layer):
  ...
  def __init__(self, **kwargs):
    ...
    self.initial_dconv_relu_max_pool.append(Conv2DTranspose(filters=64 * FLAGS.width_multiplier,kernel_size=1,strides=1,
    ...
    self.initial_dconv_relu_max_pool.append(Conv2DTranspose(filters=3 * FLAGS.width_multiplier,kernel_size=2,strides=(2,2),
            data_format='channels_last',trainable=FLAGS.module1_train))
