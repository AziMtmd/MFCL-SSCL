...
python3 pakkon.py
python3 M4/run.py --train_epochs=10 --m2_epoch=40 --m3_epoch=90
python3 pakkon.py
python3 M4/run.py --train_epochs=15 --m2_epoch=90
python3 pakkon.py
python3 M4/run.py --train_epochs=15 --m2_epoch=100
python3 pakkon.py
python3 M4/run.py --train_epochs=15 --m2_epoch=80
