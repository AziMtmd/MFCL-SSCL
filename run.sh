...
python3 pakkon.py
python3 M2/run.py --train_epochs=20 --m2_epoch=90 --learning_rate=0.3 --temperature=0.6
python3 pakkon.py
python3 M2/run.py --train_epochs=20 --m2_epoch=100 --learning_rate=0.3 --temperature=0.6
python3 pakkon.py
python3 M2/run.py --train_epochs=5 --m2_epoch=90 --learning_rate=0.3 --temperature=0.6
python3 pakkon.py
python3 M2/run.py --train_epochs=5 --m2_epoch=100 --learning_rate=0.3 --temperature=0.6
