...
class Model(tf.keras.models.Model):
  ...
  def __call__(self, inputs, training):
    ...
    hiddens, cov = self.resnet_model(features, training=training)
    # Add heads.
    ...
    if FLAGS.train_mode == 'finetune':
      ...
      return projection_head_outputs, supervised_head_outputs, cov
    else:
      return projection_head_outputs, None, cov
